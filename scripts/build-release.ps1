...
$requiredEntries = @(
    ...
    "$ReleaseRoot/app/Http/Controllers/SystemDataController.php",
    "$ReleaseRoot/app/Http/Controllers/SystemHealthController.php",
    "$ReleaseRoot/app/Services/System/SystemHealthService.php",
    ...
    "$ReleaseRoot/app/Services/Database/DatabaseMaintenanceService.php",
    ...
    "$ReleaseRoot/docs/DATABASE_MAINTENANCE_OPERATIONS.md",
    ...
    "$ReleaseRoot/resources/views/system/health.blade.php",
    ...
    "$ReleaseRoot/tests/Feature/DatabaseMaintenanceTest.php",
    "$ReleaseRoot/tests/Feature/ProjectSettingsTest.php",
    "$ReleaseRoot/tests/Feature/SystemHealthDiagnosticsTest.php",
