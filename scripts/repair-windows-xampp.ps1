...
Write-Host "Aptoria Windows/XAMPP non-destructive repair" -ForegroundColor Cyan
...
Write-Host "Repair complete. Existing SQLite data was not replaced." -ForegroundColor Green
