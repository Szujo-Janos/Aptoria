    ...
    <div class="scrollbar" data-simplebar>
        ...
        <ul class="side-nav">
            ...
            @if (auth()->user()?->isAdmin())
                ...
                <li class="side-nav-item"><a href="{{ route('program-settings.license-issuer') }}" class="side-nav-link {{ request()->routeIs('program-settings.license-issuer*') ? 'active' : '' }}"><span class="menu-icon"><i data-lucide="certificate"></i></span><span class="menu-text">{{ __('messages.nav.license_issuer') }}</span><span class="badge badge-label text-bg-warning">{{ __('messages.license_issuer.private_tool_badge') }}</span></a></li>
            @endif
