        ...
        <div class="card aptoria-panel-card mb-3">
            ...
            <div class="card-body p-0">
                <div class="list-group list-group-flush">
                    ...
                    <div class="list-group-item d-flex justify-content-between gap-3"><span class="text-muted">{{ __('messages.client_portal.decision_packages') }}</span><strong>{{ $metrics['decision_packages'] }}</strong></div>
