/**
 * Aptoria UI - Responsive Admin Theme
 * version 2.0
 *
 */
...
$(document).ready(function () {
    ...
    // Page-load panel animations are intentionally disabled for a stable QA workspace.
    // Keep the helper available as a no-op for theme compatibility.
    ...
    if ($.fn.sparkline && $("#sparkline1").length) {
...
$(window).bind("load", function () {
    // Since Aptoria UI 2.0 splash screen is disable by default
...
// Animate panel function intentionally disabled.
